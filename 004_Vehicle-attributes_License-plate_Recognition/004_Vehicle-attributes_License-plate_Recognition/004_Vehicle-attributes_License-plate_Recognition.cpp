...
void loadVehiclePlateNetWork();
void loadVehicleAttributesNetWork();
void loadVehicleLicenseNetWork();
...
int main(int argc, char** argv) {
	Mat src = imread("H:/OpenVINO_Learning/004_Vehicle-attributes_License-plate_Recognition/vehicle_01.jpg");
	...
	// 加载车辆与车牌检测网络
	loadVehiclePlateNetWork();

	// 加载车辆属性识别网络
	loadVehicleAttributesNetWork();

	// 加载车牌识别网络
	loadVehicleLicenseNetWork();
...
void loadVehiclePlateNetWork() {
	...
	network_reader.ReadNetwork("E:/models/tf_models/vehicle-license-plate-detection-barrier-0106/vehicle-license-plate-detection-barrier-0106.xml");
	network_reader.ReadWeights("E:/models/tf_models/vehicle-license-plate-detection-barrier-0106/vehicle-license-plate-detection-barrier-0106.bin");
...
void loadVehicleAttributesNetWork() {
	// SSD 车辆检测模型
	CNNNetReader network_reader;
	network_reader.ReadNetwork("E:/models/tf_models/vehicle-attributes-recognition-barrier-0039/vehicle-attributes-recognition-barrier-0039.xml");
	network_reader.ReadWeights("E:/models/tf_models/vehicle-attributes-recognition-barrier-0039/vehicle-attributes-recognition-barrier-0039.bin");
...
void loadVehicleLicenseNetWork() {
	// 加载车牌识别网络
	CNNNetReader network_reader;
	network_reader.ReadNetwork("E:/models/tf_models/license-plate-recognition-barrier-0001/license-plate-recognition-barrier-0001.xml");
	network_reader.ReadWeights("E:/models/tf_models/license-plate-recognition-barrier-0001/license-plate-recognition-barrier-0001.bin");
