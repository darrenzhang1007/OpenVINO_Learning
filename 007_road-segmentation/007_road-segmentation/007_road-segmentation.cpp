...
int main(int argc, char** argv) {
	string bin = "E:/models/tf_models/road-segmentation-adas-0001/road-segmentation-adas-0001.bin";
	string xml = "E:/models/tf_models/road-segmentation-adas-0001/road-segmentation-adas-0001.xml";
	...
	// 开视频窗口
	VideoCapture capture("H:/OpenVINO_Learning/007_road-segmentation/road_seg.mp4");
